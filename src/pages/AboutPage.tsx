...
const changelog = [
  ...
  },
  {
    ...
    date: '2026-07-23',
    items: [
      '新增全量导出功能：可将蹭饭图完整导出为 zip 文件，包含高清地图图片、所有配置数据、毛笔字图片、自定义校徽等全部资源，便于备份和分享',
      '画布留白改为自适应：根据卡片内容宽度动态计算左右留白，窄列少留白、宽列多留白，左右间隙不再强制相等，既保留呼吸感又避免浪费空间',
    ],
  },
  {
    version: 'v1.17.9',
  ...
  },
  {
    ...
    date: '2026-07-23',
    items: [
      '卡片拖拽留间隙吸附距离调小：SNAP_GAP 12→8，间隙更接近自动布局卡片间距',
    ],
  },
  {
    version: 'v1.17.7',
    date: '2026-07-23',
    items: [
      '卡片拖拽辅助线改为预览模式：靠近吸附目标 16px 内即显示辅助线引导（此前仅吸附瞬间闪现），6px 内才吸附到位；辅助线线宽调细并加 non-scaling-stroke 保持缩放时不变粗',
    ],
  },
]
