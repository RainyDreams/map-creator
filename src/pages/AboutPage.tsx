...
const changelog = [
  {
    version: 'v1.24.2',
    date: '2026-07-24 18:50',
    items: [
      '校徽大小可按人单独调整：录入面板中每个人的校徽设置里新增大小滑块（50%–200%），在全局倍率基础上叠加，自动匹配与自定义校徽都适用',
    ],
  },
  {
    version: 'v1.24.1',
    ...
    items: [
      '行内校徽大小可调：字体设置中新增「校徽大小」滑块（50%–200%，默认 100%），自动匹配与用户上传的校徽都按此缩放，行高随放大自动扩展',
    ],
  },
  {
    version: 'v1.24.0',
    date: '2026-07-24 16:40',
    items: [
      '新增竖版排版：所有省份名单卡片集中到地图下方按行流式排布、整体居中，引线照常接到卡片顶边；人多时画布自动向下扩展，竖版下拖动卡片同样自动切入自定义位置',
      '班徽大小可调：上传校徽/班徽后出现大小滑块（24–96px），实时联动地图页标题区的班徽显示',
    ],
  },
  {
    version: 'v1.23.1',
