...
const changelog = [
  {
    version: 'v1.25.0',
    date: '2026-07-24 22:05',
    items: [
      '省份/城市卡片右上角新增人数角标，一眼看清每个地方去了多少人（可在「排版设计 → 卡片样式」中关闭）',
      '画布下方可加入「各地分布统计」：全班去向按人数排序汇总，含海外与未定位人数，随导出图片一起生成（在「排版设计 → 卡片布局」中开启）',
      '卡片可拖拽调整大小：点击选中卡片后出现虚线框与右下角手柄，拖动即可调整宽高（不会小于内容自然尺寸），画布边界随之自动扩展',
    ],
  },
  {
    version: 'v1.24.5',
