...
export default function EntryPage() {
  const { resetData, fillSample } = useMapData()
      ...
      <div className="mx-auto w-full max-w-md space-y-4 px-4 py-5">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <Button
            ...
            size="sm"
            onClick={fillSample}
            className="shrink-0 border-stone-200 text-stone-600 hover:bg-stone-100 hover:text-stone-900"
          >
